    ...
    try{
      ...
      if (isNaN(args[0])) {
        return message.channel.send(new MessageEmbed()
          ...
          .setTitle(`<:no:878698997152374814> Not a valid radio station`)
      ...
      if (Number(args[1]) > 150 || Number(args[1]) < 1)
        return message.channel.send(new MessageEmbed()
          ...
          .setTitle(`${emoji.msg.ERROR} Volume Number out of Range`)
      ...
      //if not found send an error
        ...
        return message.channel.send(new MessageEmbed()
          ...
          .setTitle(`${emoji.msg.ERROR} Radio Station not found`)
