    ...
    try {
      ...
      if(!args[0]){
        return message.channel.send(new MessageEmbed()
          ...
          .setTitle(`<:no:878698997152374814> You did not add a new Default Volume`)
      ...
      if(isNaN(volume)){
        return message.channel.send(new MessageEmbed()
          .setColor(ee.wrongcolor)
          .setTitle(`<:no:878698997152374814> You did not add a valid new Default Volume`)
      ...
      return message.channel.send(new MessageEmbed()
        .setColor(ee.wrongcolor)
        .setTitle(`<:no:878698997152374814> An error occurred`)
